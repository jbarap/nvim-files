...
_G.packer_plugins = {
  ...
  ["indent-o-matic"] = {
    config = { "require('plugins.configs.indent_o_matic')" },
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/indent-o-matic",
    url = "https://github.com/Darazaki/indent-o-matic"
  },
  ["jupyter-nvim"] = {
    config = { "require('plugins.configs.jupyter')" },
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/jupyter-nvim",
    url = "https://github.com/ahmedkhalf/jupyter-nvim"
  },
  ["kanagawa.nvim"] = {
    config = { "require('plugins.configs.colorschemes')" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/kanagawa.nvim",
  ...
  ["magma-nvim"] = {
    config = { "require('plugins.configs.magma')" },
    loaded = true,
  ...
  ["matchparen.nvim"] = {
    config = { "require('plugins.configs.matchparen')" },
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/matchparen.nvim",
  ...
  ["nvim-dap"] = {
    config = { "require('plugins.configs.debug')" },
    loaded = true,
  ...
  ["project.nvim"] = {
    config = { "require('plugins.configs.project_nvim')" },
    loaded = true,
  ...
  ["targets.vim"] = {
    config = { "require('plugins.configs.targets')" },
    loaded = true,
  ...
  ["vim-arsync"] = {
    commands = { "ARshowConf", "ARsyncUp" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/vim-arsync",
  ...
  ["vim-ultest"] = {
    config = { "require('plugins.configs.ultest')" },
    loaded = true,
...
require('plugins.configs.jupyter')
...
require('plugins.configs.indent_o_matic')
...
require('plugins.configs.targets')
...
require('plugins.configs.project_nvim')
time([[Config for project.nvim]], false)
-- Config for: matchparen.nvim
time([[Config for matchparen.nvim]], true)
require('plugins.configs.matchparen')
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ARshowConf lua require("packer.load")({'vim-arsync'}, { cmd = "ARshowConf", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ARsyncUp lua require("packer.load")({'vim-arsync'}, { cmd = "ARsyncUp", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
